...
class SearchFriend extends Component {
    ...
    render() {
        ...
        if(this.profilePicList.length===this.userIdList.length && temp.length>0 && this.userIdList.length>0){
            ...
            <div>
                ...
                <div className={classes.header}>
                    <div className="input-group">
                        <input type="text" onChange={this.inputHandler} value={this.state.searchQuery} className="form-control" placeholder="Search..."/>
