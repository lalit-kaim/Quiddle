...
import {BsChatSquareDots, BsPersonDashFill, BsPersonPlusFill} from 'react-icons/bs'
import {BsPlus} from 'react-icons/bs'
import {FaChalkboardTeacher, FaMale, FaFemale, FaHandsHelping, FaUserFriends} from 'react-icons/fa'
import {GiFemale, GiMale, GiBossKey, GiSecretBook} from 'react-icons/gi'
...
class Profile extends Component{
    ...
    componentDidMount(){
        ...
        storage.ref("Profile_Cover/profile"+this.userId).getDownloadURL().then(url=>{
            this.setState({profileUrl:url})
        }).catch(err=>console.log("Error: Please Upload Profile/Cover"))
        storage.ref("Profile_Cover/cover"+this.userId).getDownloadURL().then(url=>{
